...
interface LibraryDetailsRouteParams{
  id: number;
}
...
export default function LibraryDetails() {
  ...
  const params = route.params as LibraryDetailsRouteParams;
  ...
  function handleOpenGoogleMapRoutes(){
    Linking.openURL(`https://www.google.com/maps/dir/?api=1&destination=${library?.latitude},${library?.longitude}`)
  }
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.description}>{library.about}</Text>
        ...
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            ...
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segunda à Sexta {library.opening_hours}</Text>
          </View>
